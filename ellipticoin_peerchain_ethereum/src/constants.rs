...
// pub const SAFE_ADDRESS: Address = Address(hex!("6bDCC3608e8DF882096A1b4b106C727bd28F141D"));
// pub const SAFE_ADDRESS: Address = Address(hex!("a478c2975ab1ea89e8196811f51a7b7ade33eb11"));
pub const SAFE_ADDRESS: Address = Address(hex!("7a250d5630B4cF539739dF2C5dAcb4c659F2488D"));
// pub const BRIDGE_ADDRESS: Address = Address(hex!("E55faDE7825Ad88581507C51c9f1b33827AaE5E8"));
